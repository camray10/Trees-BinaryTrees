...
describe("numGreater", function() {
  it("counts nodes in small trees", function() {
    expect(smallTree.numGreater(1)).toEqual(2);
    expect(smallTree.numGreater(2)).toEqual(3);
    expect(smallTree.numGreater(3)).toEqual(4);
    expect(smallTree.numGreater(4)).toEqual(5);
  });
